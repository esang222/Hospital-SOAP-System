            ...
            <div class="main">
                <div class="content-wrapper">
                    ...
                    <div class="forms">
                        ...
                        <input type="text" id="vital_signs" name="vital_signs" placeholder="e.g., BP: 120/80, HR: 72 bpm">

                        <label for="physical_exam">Physical Examination Findings:</label>
                        <input type="text" id="physical_exam" name="physical_exam" placeholder="e.g., normal heart sounds, no wheezing">

                        <label for="diagnostic_tests">Diagnostic Test Results:</label>
                        <input type="text" id="diagnostic_tests" name="diagnostic_tests" placeholder="e.g., CBC: WBC 7.1, Hb 13.5">

                        <label for="imaging_results">Imaging/Lab Reports:</label>
                        <input type="text" id="imaging_results" name="imaging_results" placeholder="e.g., Chest X-ray: No abnormalities">

                        <label for="general_observations">General Observations:</label>
                        <input type="text" id="general_observations" name="general_observations" placeholder="e.g., patient appears alert, oriented">
                    </div>
